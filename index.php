...
<html lang="en">
<head>
<title>HolidayEcoResortsbd HOTEL</title>
<!-- for-mobile-apps -->
...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">holidayecoresorts@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+8801911942828</li>	
					<li class="s-bar">
						<div class="search">
    ...
    <nav class="navbar navbar-default">
        <div class="navbar-header navbar-left">
            ...
            <a class="navbar-brand" href="index.php" style="display: flex; align-items: center;">
                <img src="images/logo1.png" alt="Resort Logo" style="height: 55px; margin-right: 5px;">
                <div>
                    <span style="font-size: 24px; font-weight: bold;">Holiday<span> Eco Resorts</span></span>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Holiday Eco Resorts</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Holiday Eco Resorts</h3> 
						   <p class="about-para-w3ls">A Hidden Paradise in Nature's Lap
Nestled in the heart of a picturesque village, Holiday Eco Resort offers an idyllic escape from the hustle and bustle of everyday life. Surrounded by breathtaking natural views, our resort is a sanctuary where you can reconnect with nature and find peace in the simplicity of the great outdoors.
As you step into our resort, you'll be greeted by a landscape adorned with lush greenery, vibrant flowers, and towering trees. The air here is pure and fresh, infused with the sweet scent of blooming flora. Our resort is home to charming cottages that blend seamlessly with the natural surroundings, providing you with a cozy retreat amidst nature's wonders.
Holiday Eco Resort is more than just a place to stay—it's a destination where you can immerse yourself in the beauty of the natural world. Take a leisurely stroll through our gardens, relax by the serene water features, or simply sit back and breathe in the tranquility that envelops the resort.
We extend a heartfelt welcome to all our guests. Whether you're seeking a peaceful getaway or an adventure in the great outdoors, Holiday Eco Resort is the perfect destination. Come and experience the harmony of nature, where every moment is a step closer to serenity.</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
								<div class="w3l-slider-img">
								    <img src="images/a1.jpg" class="img-responsive" alt="Hair Salon" style="width: 400px; height: 200px;">
								</div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>Enjoy your stay without the worry—settle in first and pay later! For added convenience, we also offer a prepayment option to secure your booking</p>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Mind-Blowing place!🥰 Just love it!😍. Worth to come again and Inshallah I will come again with my family.</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+8801911942828</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:holidayecoresorts@gmail.com">Holidayecoresorts@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Deotola, Narun Bazar East, Kaliganj, Gazipur, Bangladesh</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2024 HolidayEcoResortsbd . All Rights Reserved | Design by <a href="index.php">HolidayEcoResortsbd</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
