...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>Holiday Eco Resort</p>
				<p>Deotola, Narun Bazar East, Kaliganj<br>, Gazipur, <br>Bangladesh,</p>
				<p>+8801911942828</p>
			</address>
			<span><img alt="" src="assets/img/sun.png" width="100px"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email : Holidayecoresorts@gmail.com || Web : Holidayecoresortsbd.com || Phone : +8801911942828 </p>
			</div>
		</aside>
	</body>
</html>
